...
DOCKER_IMAGE=${DOCKER_IMAGE:-"md-bullseye-irods-clients-${IRODS_VERSION}:${DOCKER_TAG}"}

# The default container name matches that used by the irods_client_wrapper.sh script
